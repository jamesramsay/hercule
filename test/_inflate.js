...
test('should return contents of local files', (t) => {
  t.plan(1);
...
test('should return contents of http files', (t) => {
  t.plan(1);
...
test('should return empty string for unsupported types', (t) => {
  t.plan(1);
